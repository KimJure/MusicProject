			...
			<c:if test="${empty user}">
				<div class="toggle-button-box login-box">
					...
					<div class="list">
						...
						<ul class="list-login">
							...
							<li><a href="#" class="btn-apple" onclick="openPopup('https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=fKDlEbi3HnF8AtPDqPJc&state=hLiDdL2uhPtsftcU&redirect_uri=http://localhost:8080/dong/', 'kakaoLoginPopup', 600, 400)">네이버 로그인</a></li>
				...
				<c:if test="${not empty user}">
					...
					<div class="list">
						...
						<c:if test="${not empty user.naver_id}">
												<ul class="list-login">
							<li><a href="#" class="btn-kakao" onclick="openPopup('https://kauth.kakao.com/oauth/authorize?client_id=bb0b3857071f6812cd2383f2d98d37e9&redirect_uri=http://localhost:8080/dong/board/KakaoCallBack&response_type=code', 'kakaoLoginPopup', 600, 400)">카카오 로그인</a></li>
...
" class="text-bold">최근 감상 곡</a></h3>
		...
		<a href="/myMusic" class="btn-profile"><img src="${user.profile}" alt="" onerror="this.src='//image.genie.co.kr/imageg/web/common/default_profile.png';"></a>
		</c:if>
