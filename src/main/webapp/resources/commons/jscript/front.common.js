...
// UserAgent瑜� �댁슜�댁꽌 IE�몄�瑜� 泥댄겕�⑸땲��.
var ua = navigator.userAgent.toLowerCase();
// IE7�� 釉뚮씪�곗� �붿쭊紐낆씤 Trident媛� �녾퀬 IE11�� MSIE�� 臾몄옄�댁씠 �놁쑝誘�濡� �� 媛�吏� 寃쎌슦瑜� �� 泥댄겕�⑸땲��.
if( ua.indexOf( 'msie' ) != -1 || ua.indexOf( 'trident' ) != -1 ) {
	...
	var classNames = '';
	// 湲곗〈�� 諛⑹떇�� is-ie �쇰뒗 �대옒�ㅻ룄 異붽��대큶�덈떎.
	classNames += ' is-ie';
	// 留덉갔媛�吏�濡� 湲곗〈�� 諛⑹떇�� �꾩옱 踰꾩쟾 �쒖떆瑜� 異붽��대큶�덈떎.
...
/* setTimeout, setinterval�� �댁슜�� �좊땲硫붿씠�섏씠 �꾩슂�좉꼍�� ���� �ъ슜
 * 異쒖쿂 : http://msdn.microsoft.com/ko-kr/library/ie/hh920765%28v=vs.85%29.aspx
 */
...
FG_loadingImageSrc = '//image.genie.co.kr/imageg/web/common/loading_r1.png';
...
(function() {
	...
	MY_ALBUM.prototype = {
		...
		_click:function(e) {
			...
			//留덉씠 �⑤쾾�� �닿린 湲곕뒫�� �꾪븯�� 異붽���. �띿꽦�퇒. 2013-05-06
...
(function() {
	...
	LAYER_POPUP.prototype = {
		...
		show:function(element) {
			//濡쒓렇�� �덉씠�대� �붿씠�� �몄텧�섎뒗 怨녹씠 �놁�留� �섎뱶肄붾뵫�� 怨녹씠 留롮븘 怨듯넻 泥섎━ 遺�遺꾩뿉�� �덉쇅泥섎━��
			try {
...
(function() {
	...
	LIST_SORT.prototype = {
		...
		up:function() {
			/*
			 * 泥댄겕�� 紐⑸줉 1媛� �� ��
			 * - 泥댄겕�� 紐⑸줉�� �ъ깮紐⑸줉 泥ル쾲吏� 怨≪씪 �� : 紐낅졊 臾댁떆
			 * - 泥ル쾲吏� 怨� �꾨옒�� �� : -1 �대룞
			 *
			 * 泥댄겕�� 紐⑸줉�� 2媛� �댁긽�� ��
			 * - 泥댄겕�� 紐⑸줉 以� �ъ깮紐⑸줉 泥ル쾲吏� 怨≪씠 �ы븿�섏뼱 �덉쓣 �� : 泥ル쾲吏� 怨� 紐낅졊 臾댁떆
			 * - 泥댄겕�� 紐⑸줉 以� �ъ깮紐⑸줉 泥ル쾲夷� 怨≪씠 �놁쓣 �� : 泥ル쾲吏� 怨� -1 �대룞
			 * - �섎㉧吏� 怨〓뱾�� 泥ル쾲吏멸끝 �꾨옒濡� �쒖꽌��濡� �대룞
			 */
			var that = this,
		...
		down:function() {
			/*
			 * 泥댄겕�� 紐⑸줉 1媛� �� ��
			 * - 泥댄겕�� 紐⑸줉�� �ъ깮紐⑸줉 留덉�留� 怨≪씪 �� : 紐낅졊 臾댁떆
			 * - 留덉�留� 怨� �꾩씪 �� : 1 �대룞
			 *
			 * 泥댄겕�� 紐⑸줉�� 2媛� �댁긽�� ��
			 * - 泥댄겕�� 紐⑸줉 以� �ъ깮紐⑸줉 留덉�留� 怨≪씠 �ы븿�섏뼱 �덉쓣 �� : 留덉�留� 怨� 紐낅졊 臾댁떆
			 * - 泥댄겕�� 紐⑸줉 以� �ъ깮紐⑸줉 留덉�留� 怨≪씠 �놁쓣 �� : 留덉�留� 怨� 1 �대룞
			 * - �섎㉧吏� 怨〓뱾�� 留덉�留� 怨� �꾨줈 �쒖꽌��濡� �대룞
			 */
			var that = this,
				checkListsLength = that.checkLists.length,
			...
			if(prop == "RANDOM") {
				...
				*/
				...
				that.lists.sort(function (a, b) {
					var an = $.trim($(a).find('[sort-field="' + prop + '"]').text().replace('19湲�', '').replace(/裕ㅻ퉬|怨듭뿰|�곗�|�щ���|硫붿씠��|湲고�|諛⑹넚|�ㅽ럹��|吏��덉뒪��/g, '')),
						bn = $.trim($(b).find('[sort-field="' + prop + '"]').text().replace('19湲�', '').replace(/裕ㅻ퉬|怨듭뿰|�곗�|�щ���|硫붿씠��|湲고�|諛⑹넚|�ㅽ럹��|吏��덉뒪��/g, ''));
		...
		_template:function(arr) {
			...
			switch(this.listType.toLowerCase()) {
				case 'play_list':
					...
					if(arr.ADLT_YN == "Y") {
						html += '		<span class="icon icon-19">19<span class="hide">湲�</span></span>';
					}
					...
					html += '	</a>';
					html += '	<a href="#" class="btn-basic btn-listen" onclick="fnPlayOn(this); return false;">�ｊ린</a>';
					html += '	<div class="toggle-button-box has-add-album">';
					html += '		<button type="button" class="btn btn-basic btn-more">�붾낫湲�</button>';
					html += '		<ul class="list">';
					html += '			<li><a href="#" class="item" title="�덉갹 �대┝" onclick="fnViewSongInfoPop(\'' + arr.SONG_ID + '\'); return false;">媛���</a></li>';
					html += '			<li><a href="#" class="item" title="�덉갹 �대┝" onclick="shareDo(\'' + arr.SONG_ID + '\');return false;">怨듭쑀�섍린/�뚯븙�섎늻湲�</a></li>';
					if(arr.ADLT_YN != "Y") {
						html += '			<li><a href="#" class="item" title="�덉갹 �대┝" onclick="fnGiftSong(\'' + arr.SONG_ID + '\');return false;">�좊Ъ�섍린</a></li>';
					}
					html += '		</ul>';
					html += '	</div>';
				...
				case 'play_list_mv':
					...
					html += '		   <img src="//image.genie.co.kr' + arr.IMG + '" onerror="this.src=\'//image.genie.co.kr/imageg/web/common/blank_mv_120.gif\';" alt="' + arr.MV + '">';
					...
					html += '		<button type="button" class="btn btn-basic btn-more">�붾낫湲�</button>';
					html += '		<ul class="list">';
					html += ( songId == '-1' ? '' : '			<li><a href="#" class="item" title="�덉갹 �대┝" onclick="fnViewSongInfoPop(\'' + songId + '\'); return false;">怨� �뺣낫</a></li>' );
					html += ( albumId == '-1' ? '' : '			<li><a href="#" class="item" title="�덉갹 �대┝" onclick="fnViewAlbumPop(\'' + albumId + '\'); return false;">�⑤쾾 �뺣낫</a></li>' );
					html += '			<li><a href="#" class="item" title="�덉갹 �대┝" onclick="fnViewArtistPop(\'' + arr.ARTIST_ID + '\'); return false;">�꾪떚�ㅽ듃 �뺣낫</a></li>';
					html += '			<li><a href="#" class="item" title="�덉갹 �대┝" onclick="fnViewVideoPop(\'' + arr.MV_ID + '\'); return false;">�곸긽 �뺣낫</a></li>';
					html += '		</ul>';
					html += '	</div>'
...
(function() {
	...
	LIST_DISPLAY.prototype = {
		_load:function(delay) {
			var that = this,
				wrapWidth = that.wrap.width(), // 媛먯떥�� �곸뿭 �볦씠
				box = that.wrap.find('li'), // 釉붾윮 諛곗뿴
				boxLine = box.css('border-right-width').split('px')[0]; // 蹂대뜑 �볦씠
			boxCount = box.length, // 釉붾윮 珥앷갗��
				boxWidth = box.eq(0).outerWidth(true), // 釉붾윮 �볦씠
				boxHeight = box.eq(0).outerHeight(true), // 釉붾윮 �믪씠
				rowCount = parseInt(wrapWidth / boxWidth), // 媛�濡� 媛�닔
				columnCount = Math.ceil(boxCount / rowCount), // �몃줈 媛�닔
				delayTime = delay ? delay : 1500 //�쒖옉 硫덉땄 �쒓컙
...
(function() {
	...
	AUTO_SEARCH.prototype = {
		...
		_getRecommendJson:function(json) {
			...
			that.popularFoot = $('<div />').appendTo(that.popularContents).html('<button type="button" class="close">�リ린</button>').addClass('btns clearfix');
		...
		_create:function(json) {
			...
			return {
				tag:function() {
					that.tagTitle = $('<h3 />').appendTo(that.autoCompleteResult).html('愿��� �쒓렇').addClass('hide');
				...
				song:function() {
					that.songTitle = $('<h3 />').appendTo(that.autoCompleteResult).html('<a href="/search/searchSong?query=' + that.hook.val() + '">怨�</a>').addClass('title');
					that.songWrap = $('<ul />').appendTo(that.autoCompleteResult).addClass('list-basic');
					that.songList = [];

					$.each(json.song, function(i) {
						var imgURL = (json.song[i].image == null) ? '//image.genie.co.kr/imageg/web/common/blank_68.gif' : '//image.genie.co.kr' + json.song[i].image,
							_cover = $('<div />', {
								'class':'cover'
							}).html('<span class="mask"></span><img src="'+ imgURL +'"  onerror="this.src=\'//image.genie.co.kr/imageg/web/common/blank_68.gif\';" alt="怨� �쒕ぉ�� �ㅼ뼱媛묐땲��." />'),
							_title = $('<span />', {
				...
				artist:function() {
					that.artistTitle = $('<h3 />').appendTo(that.autoCompleteResult).html('<a href="/search/searchArtist?query=' + that.hook.val() + '">�꾪떚�ㅽ듃</a>').addClass('title');
					that.artistWrap = $('<ul />').appendTo(that.autoCompleteResult).addClass('list-basic list-artist');
					that.artistList = [];

					$.each(json.artist, function(i) {
						var imgURL = (json.artist[i].image == null) ? '//image.genie.co.kr/imageg/web/common/blank_artist_68.gif' : '//image.genie.co.kr' + json.artist[i].image,
							_cover = $('<div />', {
								'class':'cover'
							}).html('<span class="mask"></span><img src="'+ imgURL +'"  onerror="this.src=\'//image.genie.co.kr/imageg/web/common/blank_68.gif\';" alt="�꾪떚�ㅽ듃紐낆씠 �ㅼ뼱媛묐땲��." />'),
							_artist = $('<span />', {
								'class':'artist ellipsis'
				...
				album:function() {
					that.albumTitle = $('<h3 />').appendTo(that.autoCompleteResult).html('<a href="/search/searchAlbum?query=' + that.hook.val() + '">�⑤쾾</a>').addClass('title');
					that.albumWrap = $('<ul />').appendTo(that.autoCompleteResult).addClass('list-basic');
					that.albumList = [];

					$.each(json.album, function(i) {
						var imgURL = (json.album[i].image == null) ? '//image.genie.co.kr/imageg/web/common/blank_68.gif' : '//image.genie.co.kr' + json.album[i].image,
							_cover = $('<div />', {
								'class':'cover'
							}).html('<span class="mask"></span><img src="'+ imgURL +'"  onerror="this.src=\'//image.genie.co.kr/imageg/web/common/blank_68.gif\';" alt="�⑤쾾紐낆씠 �ㅼ뼱媛묐땲��." />'),
							_album = $('<span />', {
								'class':'track ellipsis'
		...
		_createRecommend:function() {
			...
			return {
				popular:function() {
					...
					that.popularTitle = $('<h3 />').appendTo(that.popularWrap).html('<button type="button">�멸린寃��됱뼱</button>').addClass('tab');
				...
				recent:function() {
					...
					that.recentTitle = $('<h3 />').appendTo(that.recentWrap).html('<button type="button">理쒓렐寃��됱뼱</button>').addClass('tab');
					that.recentContents = $('<div />').insertAfter(that.recentTitle).addClass('list');
					$('<p />').prependTo(that.recentContents).html('理쒓렐 寃��됱뼱媛� �놁뒿�덈떎.').addClass('no-data');
					that.recentFoot = $('<div />').appendTo(that.recentContents).html('<button type="button" class="btn-delete">理쒓렐寃��됱뼱 �꾩껜��젣</button><button type="button" class="close">�リ린</button>').addClass('btns clearfix');
...
(function() {
	...
	GRAPH.prototype = {
		...
		_load:function() {
			...
			if(that._blindFlag){
				...
				$.map(blindRectWidth, function (value, label, array) {
					...
					if (value !== unitWidth) {
						that._blindArr[label + 10] = that._canvas.rect(minX[label], 0, blindRectWidth[label] - unitWidth , that._option.h).attr({'stroke': 0, 'fill': 'url("//image.genie.co.kr/imageg/web/main/' + imgUrl + '")'}).toBack();
		...
		_setPoint:function(i, k) {
			...
			if(that._isMinimal) that._pointArr[k].attr({'x':parseFloat(that._dataPathArr[i][k*2])-19, 'y':that._dataPathArr[i][k*2+1]-10, 'fill':'url("//image.genie.co.kr/imageg/web/main/point_'+that._minimalIdx+(k === 11?'_active' :'')+'.png")'}).toFront();
			else that._pointArr[k].attr({'x':parseFloat(that._dataPathArr[i][k*2])-10, 'y':that._dataPathArr[i][k*2+1]-10, 'fill':'url("//image.genie.co.kr/imageg/web/chart/point_'+i+(isTop ? '_top':'')+'.png")'}).toFront();
			if(!that._isMinimal) {
				...
				that._pointArr[k].data({'i':i, 'k':k, 'cx':parseFloat(that._dataPathArr[i][k*2])+0.5, 'isTop':isTop}).mouseover(function() {
					...
					that._parent.find('.detail-info .info').html(that._arrTimeList[k]+':00<br />'+(rank_idx/2+3)+'��');
				});
			}
		},
		_rolling:function() {
		...
		if(val[1][i][3] == 'close') {
			btn.bind('click', function() {
				...
				try{
					...
					window.opener.postMessage({reload:'reload'},'*');
				}
				self.close();
				return false;
			});
